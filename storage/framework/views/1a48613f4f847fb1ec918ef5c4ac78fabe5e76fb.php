...
<?php $__env->startSection('content'); ?>
    ...
    <section class="p-0 full-screen ">
        <div class="slider-fade2 owl-carousel owl-theme w-100 min-vh-100">
            <div class="item bg-img cover-background overlay-dark" data-overlay-dark="5"
                 data-background="<?php echo e(asset('assets/images/settings')); ?>/<?php echo e($setwhats[0]->image); ?>">
                    ...
                    <div class="row align-items-center min-vh-100 pt-6 pt-md-0 row_ar">
                        <div class="col-md-10 col-lg-8 col-xl-7 col-xxl-6 mb-1-9 mb-lg-0 pt-6 pb-12 py-sm-20">
                                <span
                                        ...
                                        data-in-effect=""><?php echo e($setwhats[0]->company_name); ?></span>
                            <h1 class="text-white mb-2 fw-bold title animated fadeInUp"><?php echo e($setwhats[0]->content); ?></h1>
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div
                                ...
                                <?php if($service->image != null): ?>
                                   <img src="<?php echo e(asset('assets/images/services')); ?>/<?php echo e($service->image); ?>" width="50px" height="50px">
                                <?php else: ?>
                                ...
                                <?php endif; ?>
                                    ...
                                    <h4 class="h6 mb-2"><?php echo e($service->name); ?>

                                    </h4>
                                    <p class="mb-0 display-30"><?php echo e($service->details); ?></p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 mb-6 mb-md-8 mb-lg-0 wow fadeIn" data-wow-delay="200ms">
                    <div class="position-relative">
                        <div class="position-relative overflow-hidden pe-xl-7">
                            <img src="<?php echo e(asset('assets/images/content')); ?>/<?php echo e($whoUs->image); ?>" class="position-relative pb-1-9 z-index-1" alt="<?php echo e($whoUs->name); ?>">
                        </div>
                ...
                <div class="col-lg-6 wow fadeIn" data-wow-delay="400ms">
                    <div class="ps-xl-4">
                        <div class="title-style2 text-start mb-1-3">
                            <span class="sub-title"><?php echo e($whoUs->name); ?></span>
                            <h2 class="cd-headline cd-headline-about clip font-weight-600"><?php echo e($whoUs->title); ?><br>
                                <span class="cd-words-wrapper p-0 d-block d-sm-inline-block d-md-block d-xl-inline-block">
                                    <?php if($titleDetails != null): ?>
                                        <?php $__currentLoopData = $titleDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $title): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                           <?php if($key == 0): ?>
                                                 <b class="is-visible font-weight-600"><?php echo e($title); ?></b>
                                            <?php else: ?>
                                                 <b class="font-weight-600"><?php echo e($title); ?></b>
                                            <?php endif; ?>
                        ...
                        <?php if($contentBody != null): ?>
                            <ul class="list-style1 mb-0 text-dark">
                                <?php $__currentLoopData = $contentBody; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $content): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <!-- SERVICES
    ================================================== -->
    <?php if($sections != null || !empty($sections)): ?>
                    ...
                    <div class="categories-slider owl-carousel owl-theme wow fadeIn" data-wow-delay="200ms">
                        <?php $__currentLoopData = $sections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $section): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="card-body p-0">
                                ...
                                <h3 class="h5 mb-3"><a href="#"><?php echo e($section->name); ?></a></h3>
                                <p><?php echo e($section->details); ?></p>
                            </div>
                            <a href="/dashboard/courses/show/<?php echo e($section->id); ?>" class="text-uppercase read-more">معرفة المزيد</a>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                </div>
    ...
    <?php if($ourTeam != null || !empty($ourTeam)): ?>
            ...
            <div class="row mt-n1-9">
                <div class="col-md-12">
                    <div class="team-slider owl-carousel owl-theme wow fadeIn" data-wow-delay="200ms">
                        <?php $__currentLoopData = $ourTeam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $person): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="team-style3">
                                <div class="pb-1-2">
                                    <div class="team-image position-relative">
                                        <div class="team-icons">
                                            <span class="team-icon ti-close"></span>
                                            <a href="<?php echo e($person->twitter); ?>" class="team-icon fab fa-twitter"></a>
                                            <a href="<?php echo e($person->facebook); ?>" class="team-icon fab fa-facebook-f"></a>
                                            <a href="<?php echo e($person->instagram); ?>" class="team-icon fab fa-instagram"></a>
                                        </div>
                                        <a href="/dashboard/ourteam/" class="team-inner-img">
                                            <img src="<?php echo e(asset('assets/images/ourteam')); ?>/<?php echo e($person->image); ?>" class="rounded-circle" alt="<?php echo e($person->name); ?>">
                                        </a>
                                    </div>
                                </div>
                                <div class="text-center">
                                    <h3 class="h5 mb-1"><?php echo e($person->name); ?></h3>
                                    <span class="small"><?php echo e($person->position); ?> </span>
                                </div>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   ...
   <?php endif; ?>
    ...
    <!-- PORTFOLIO
    ================================================== -->
    <?php if($portfolio != null || !empty($portfolio)): ?>
                ...
                <div class="col-lg-8 wow fadeIn" data-wow-delay="400ms">
                    <div class="position-relative h-100 vw-lg-60">
                        <div class="portfolio-slider owl-carousel owl-theme h-100 w-100 ms-lg-8 ms-xxl-16">
                            <?php $__currentLoopData = $portfolio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subject): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="portfolio-style2">
                                    <img src="<?php echo e(asset('assets/images/portfolio')); ?>/<?php echo e($subject->image); ?>" alt="<?php echo e($subject->title); ?>">
                                    <div class="portfolio-inner">
                                        <div class="portfolio-overlay"></div>
                                        <div class="portfolio-text">
                                            <h3 class="h4 mb-1"><a href="/dashboard/portfolio/<?php echo e($subject->id); ?>" class="text-white"><?php echo e($subject->title); ?></a></h3>
                                            <span class="text-white"><?php echo e($subject->details); ?></span>
                                        </div>
                                    </div>
                                </div>
                             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
    <?php if($partners != null || !empty($partners)): ?>
                    ...
                    <div class="owl-stage">
                        ...
                        <div class="owl-item">
                            <div class="image-wrapper">
                                <img class="main-image" src="<?php echo e(asset('assets/images/partners')); ?>/<?php echo e($partner->image); ?>" alt="<?php echo e($partner->name); ?>" title="<?php echo e($partner->name); ?>">
                            </div>
                        </div>
                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
    ...
    <?php endif; ?>
    <?php if($statics != null || !empty($statics)): ?>
    <section class="p-1-9 p-md-5 wow fadeIn bg-secondary border-radius-10 mx-auto w-95 counter" data-wow-delay="100ms">
        <div class="container">
            <div class="row text-center position-relative z-index-1">
                <?php $__currentLoopData = $statics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stats): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-sm-6 col-lg-3 mb-1-6 mb-sm-1-9 mb-lg-0">
                        <div class="d-flex justify-content-center align-items-center">
                            <div class="flex-shrink-0 display-14 display-sm-12 display-lg-10 text-white fw-bold w-75px w-lg-auto">
                                <span class="countup"><?php echo e($stats->details); ?></span><?php echo e($stats->sign); ?>

                            </div>
                            <div class="flex-grow-1 ms-3 ms-xl-4 text-start">
                                <h4 class="h6 font-weight-500 text-white mb-0 text-uppercase lh-base"> <?php echo e($stats->title); ?></h4>
                            </div>
                ...
                <div class="row g-xl-5 mt-n2-2 portfolio">
                    ...
                    <div class="col-md-6 col-lg-4 mt-2-2">
                        <article class="card card-style5 h-100">
                            <div class="card-img">
                                <img src="<?php echo e(asset('assets/images/events')); ?>/<?php echo e($event->image); ?>" class="card-img-top border-radius-10" alt="<?php echo e($event->title); ?>" width="100" height="100">
                                <div class="post-date">

                                    <span class="mb-0 d-block"><?php echo e(date("d M ", strtotime($event->created_at))); ?></span>
                            ...
                            <div class="card-body position-relative">
                                ...
                                <a href="/dashboard/event/<?php echo e($event->id); ?>" class="text-secondary text-uppercase fw-bold display-30"><?php echo e($event->title); ?></a>
                                <p><?php echo e($event->details); ?></p>

                                <a href="/dashboard/event/<?php echo e($event->id); ?>" class="text-uppercase read-more">معرفة المزيد</a>
                            </div>
                        </article>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.sitelayouts', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\academic\resources\views/site/sitehome.blade.php ENDPATH**/ ?>