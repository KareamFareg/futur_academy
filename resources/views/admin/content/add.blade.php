                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="/dashboard/content/insert" class="mt-2" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" id="TitleAr" class="form-control" name="TitleAr"  required/>
                                                </div>
                                            </div>
                                            ...
                                            @endif
                                                ...
                                                <select class="form-control" id="Category" name="Category" hidden>
                                                    ...
                                                    <option value="{{$SingleCat->id}}" selected>{{$SingleCat->Title}}</option>
                                                     @endforeach
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <textarea  name="ContentAr" class="tinymce" id="textareaar" row="6" col="200" ></textarea> 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <div id="blog-editor-wrapper">
                                                    <textarea  name="ContentEn" id="textareaen" row="6" col="200"></textarea> 
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
