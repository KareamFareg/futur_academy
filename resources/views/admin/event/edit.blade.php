                                    ...
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="HIDDEN" id="id" class="form-control" name="id" value="{{$event->id}}"  required/>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-12 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <textarea class="form-control" id="exampleFormControlTextarea1" name="details" rows="3" required>{{$event->details}}</textarea>
                                            </div>
                                        </div>
                                                            ...
                                                            <div class="d-inline-block">
                                                                <div class="form-group mb-0">
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" id="blogCustomFile" accept="image/*" name="image"  value="{{$event->image}}" />
                                                                        @if($event->image != null)
                                                                            <img width="200" height="200" style="margin-bottom: 150px" src="{{asset('assets/images/events')}}/{{$event->image}}">
                                                                        @endif
