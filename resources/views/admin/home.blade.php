...
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$stat[0]->customerorders}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0">طلبات العملاء</p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
{{--                                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">--}}
...
{{--                                                </div>--}}
{{--                                                <div class="media-body my-auto">--}}
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$stat[0]->FS}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0"> دراسات الجدوي</p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>  <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">--}}
{{--                                            <div class="media">--}}
{{--                                                <div class="avatar bg-light-info mr-2">--}}
{{--                                                    <div class="avatar-content">--}}
{{--                                                        <i data-feather="user" class="avatar-icon"></i>--}}
...
{{--                                                </div>--}}
{{--                                                <div class="media-body my-auto">--}}
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$stat[0]->productline}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0"> خطوط الانتاج </p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
...
{{--                                                </div>--}}
{{--                                                <div class="media-body my-auto">--}}
{{--                                                    <h4 class="font-weight-bolder mb-0">{{$stat[0]->investus}}</h4>--}}
{{--                                                    <p class="card-text font-small-3 mb-0">استثمراتنا</p>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
