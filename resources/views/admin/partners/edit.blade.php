...
@section('title','تعديل بيانات شركاء النجاح ')
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="/dashboard/partner/update/{{$partner->id}}" class="mt-2" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="text" id="content" class="form-control" name="content"  value="{{$partner->content}}" />
                                                </div>
                                            </div>
                                                                ...
                                                                <div class="form-group mb-0">
                                                                    <div class="custom-file">
                                                                        ...
                                                                        @if($partner->image != null)
                                                                            <img width="200" height="200" style="margin-bottom: 150px" src="{{asset('assets/images/partners')}}/{{$partner->image}}">
                                                                        @endif
                                                                        <label class="custom-file-label" for="blogCustomFile">{{$partner->name }}</label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
