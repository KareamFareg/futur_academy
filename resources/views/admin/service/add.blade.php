                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!-- Form -->
                                <form action="/dashboard/service/insert" class="mt-2" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                         ...
                                         <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="type" class="form-control" id="exampleFormControlSelect2">
                                                  <option value="1">خدمات للطلاب</option>
                                                  <option value="0">خدمات لأعضاء هيئه التدريس</option>
                                                </select>
                                            </div>
                                        </div>
