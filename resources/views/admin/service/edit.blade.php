                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="/dashboard/service/update" class="mt-2" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">

                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="name">إسم الخدمه</label>
                                         ...
                                         <div class="col-md-6 col-12">
                                            <div class="form-group mb-2">
                                                ...
                                                <select name="type" class="form-control" id="exampleFormControlSelect2">
                                                    @if($service[0]->type == '1')
                                                        <option value="1" >الخدمه خاصة بالطلاب </option>
                                                        <option value="0" selected>الخدمه خاصة بهيئه التدريس</option>

                                                  @else
                                                        <option value="0" >الخدمه خاصة بهيئه التدريس</option>
                                                        <option value="1" selected>الخدمه خاصة بالطلاب</option>
                                                            ...
                                                            <div class="d-inline-block">
                                                                <div class="form-group mb-0">
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" id="blogCustomFile" accept="image/*" name="image"  value="{{$service[0]->image}}" />
                                                                        @if($service[0]->image != null)
                                                                            <img width="200" height="200" style="margin-bottom: 150px" src="{{asset('assets/images/services')}}/{{$service[0]->image}}">
                                                                        @endif
