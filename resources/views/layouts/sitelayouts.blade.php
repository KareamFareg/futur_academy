...
<?php $settings=Mrabe3Helper::Getsettings();?>
    ...
    <!-- favicon -->
{{--    <link rel="shortcut icon" href="/home_assets/img/logo.png">--}}
    <link rel="shortcut icon" href="{{asset('assets/images/settings')}}/{{$settings[0]->logo}}">
    <!-- title  -->
    <title>أكاديمية المستقبل التعليمية</title>

{{--    <link href="{{asset('assets/images/logo.png')}}" rel="icon">--}}
    <link src="{{asset('assets/images/settings')}}/{{$settings[0]->logo}}" rel="icon">
                        ...
                        <div class="menu_area alt-font">
                            <nav class="navbar navbar-expand-lg navbar-light p-0">
                                <div class="navbar-header navbar-header-custom">
                                    <a href="/" class="navbar-brand"><img id="logo" src="{{asset('assets/images/settings')}}/{{$settings[0]->logo}}"
                                                                                   alt="logo"></a>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-1-9 mb-lg-0 wow fadeIn" data-wow-delay="200ms">
                    <div class="logo-footer">
                        <img src="{{asset('assets/images/settings')}}/{{$settings[0]->logo}}" class="" alt="..." />
                    </div>
                    ...
                    <div class="social-icons2">
                        <ul class="ps-0 mb-0">
                            <li><a href="#!"><i class="fab fa-facebook-f">{{$settings[0]->fb}}</i></a></li>
                            <li><a href="#!"><i class="fab fa-twitter">{{$settings[0]->tw}}</i></a></li>
                            <li><a href="#!"><i class="fab fa-instagram">{{$settings[0]->insta}}</i></a></li>
                            <li><a href="#!"><i class="fab fa-linkedin-in"></i>{{$settings[0]->linkedin}}</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-lg-8">
                                ...
                                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0 text-white opacity8 small">{{$settings[0]->phone}}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0 text-white opacity8 small">{{$settings[0]->email}}</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-4">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="mb-0 text-white opacity8 small"> {{$settings[0]->address}}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
