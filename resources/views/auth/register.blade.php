...
<head>
    ...
    <meta name="description" content="العقيلي admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
    <meta name="keywords" content="admin template, العقيلي admin template, dashboard template, flat admin template, responsive admin template, web app">
    <meta name="author" content="PIXINVENT">
    <title>Register Page -جامعة المستقبل - Bootstrap HTML admin template</title>
...
<div class="app-content content ">
            ...
            <div class="auth-wrapper auth-v2">
                <div class="auth-inner row m-0">
                    <!-- Brand logo--><a class="brand-logo" href="javascript:void(0);">
                        ...
                        <h2 class="brand-text text-primary ml-1">جامعة المستقبل</h2>
                    </a>
                    <!-- /Brand logo-->
                    <!-- Left Text-->
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            <h2 class="card-title font-weight-bold mb-1">مرحبا بك في جامعة المستقبل 👋</h2>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group row">
                                    <label for="fullName" class="col-md-4 col-form-label text-md-right">الأسم بالكامل</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <i class="fa fa-eye" id="togglePassword1" style="color:blue;font-size: larger; cursor: pointer;"></i>
                                ...
                                <div class="form-group row">
                                    <label for="phone" class="col-md-4 col-form-label text-md-right">رقم المحمول</label>
                                ...
                                <div class="form-group row">
                                    <label for="city" class="col-md-4 col-form-label text-md-right">المدينه</label>
                                ...
                                <div class="form-group row">
                                    <label for="area" class="col-md-4 col-form-label text-md-right">المنطقه</label>
    ...
    <script>
        $(window).on('load', function() {
            ...
            const current_password = document.querySelector('#password');
...
{{--            </div>--}}
{{--            <div>--}}
{{--                <x-jet-label for="area" value="area" />--}}
...
{{--                <x-jet-input id="year" class="block mt-1 w-full" type="text" name="year" :value="old('year')" required autofocus autocomplete="year" />--}}
{{--            </div>--}}
{{--            <div>--}}
{{--                <x-jet-label for="serial_number" value="serial_number" />--}}
{{--                <x-jet-input id="serial_number" class="block mt-1 w-full" type="text" name="serial_number" :value="old('serial_number')" required autofocus autocomplete="serial_number" />--}}
{{--            </div>--}}
