...
@section('title','كل الطلاب الذين لم يكتمل تسجيلهم')
@section('extracss')
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">كل الطلاب الذين لم يكتمل تسجيلهم </h4>
                            </div>
                                        ...
                                        @foreach($students as $student)
                                            @if($student->utype !== "ADM" && $student->is_graduated == 0)
                                                <tr>
                                                    ...
                                                    @else
                                                        <td class="text-nowrap" style="color: red">لا يحتوي علي قيمه</td>
                                                    @endif
                                                    @if($student->serial_number != null)
