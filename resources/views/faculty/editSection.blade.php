                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="{{route('edit-section',['id' => $section->id])}}" class="mt-2" method="post" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="name">إسم القسم</label>
                                                    <input type="text" id="name" class="form-control" name="name" required value="{{$section->name}}"/>
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                            ...
                                                            <div class="d-inline-block">
                                                                <div class="form-group mb-0">
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" id="blogCustomFile" accept="image/*" name="icon" value="{{$section->icon}}"   />
                                                                        @if($section->icon != null)
                                                                             <img width="200" height="200" style="margin-bottom: 150px" src="{{asset('assets/images/sections/icons')}}/{{$section->icon}}">
                                                                        @endif
                                                    ...
                                                    <div class="media flex-column flex-md-row">
                                                        <div class="media-body">
                                                            <div class="d-inline-block">
                                                                <div class="form-group mb-0">
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" id="blogCustomFile" accept="image/*" name="image" value="{{$section->image}}"   />
                                                                        @if($section->image != null)
                                                                          <img width="200" height="200" style="margin-bottom: 150px" src="{{asset('assets/images/sections')}}/{{$section->image}}">
                                                                        @endif
                                                                         <label class="custom-file-label" for="blogCustomFile">اختار الصورة</label>
                                                                    </div>
                                                                </div>
