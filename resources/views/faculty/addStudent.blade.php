                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <!-- Form -->
                                    <form action="/dashboard/student/insert" class="mt-2" method="POST" enctype="multipart/form-data">
                                    @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <select class="form-control" id="dependent" name="section_id"  >
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" name="year" id="year" class="form-control" step="1" min="1" REQUIRED />
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                            ...
                                                            <div class="d-inline-block">
                                                                <div class="form-group mb-0">
                                                                    <div class="custom-file">
                                                                        <input type="file" class="custom-file-input" id="blogCustomFile" accept="image/*" name="img"  REQUIRED />
