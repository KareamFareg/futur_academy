...
@section('title',' اضافه محتوي جديد')
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                <!-- Form -->
                                    <form action="{{route('add-content'}}" class="mt-2" method="post" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="titleDetails">العنوان الفرعي</label>
                                                    <input type="text" id="titleDetails" class="form-control" name="titleDetails" required />
                                                </div>
                                            </div>
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    <label for="contentBody"> التفاصيل</label>
                                                    <input type="text" id="contentBody" class="form-control" name="contentBody" required />
                                                </div>
                                            </div>
